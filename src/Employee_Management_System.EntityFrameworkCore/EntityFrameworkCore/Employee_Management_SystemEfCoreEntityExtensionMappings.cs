...
public static class Employee_Management_SystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE Employee_Management_SystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
